...
<link rel="stylesheet" href="<?= SITE.'css/sliderscss.scss'; ?>"> <!-- BALISE SCSS POUR SLIDER -->
                    ...
                    <div class="">
                            <div class="">
                                    ...
                                    <p class="fonts title">Regardez la saison 1 <button type="button"  class="btn ml-1 bt1 ">18+</button> 
                                      ...
                                      <p class="fonts">Le sorceleur Geralt, un chasseur de monstres mutant, se bat pour trouver sa place dans un monde où les humains se révèlent souvent plus vicieux que les bêtes.
                                      </p>
                                             <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                                  
                                                    <div class="btn-group" role="group" aria-label="Third group">
                                                        <button type="button" class="btn  mr-3 bt"><i class="fas fa-play ic"></i> Lecture</button>
                                                      </a>
                                                      </div>
                                                    <div class="btn-group" role="group" aria-label="Third group">
